  ...
  return (
    <div className="lg:px-28 md:px-20 px-3 pt-16 space-y-5">
        <div className="flex items-center justify-between">
            <input type="text" placeholder="Filter by company Name or Role" className="outline-none border border-slate-200 px-3 py-1 rounded-md opacity-70" onChange={(e) => setInputText(e.target.value)} />
            <Link to="/recruiter/jobs/create" className="bg-purple-500 px-5 py-2 rounded-md text-white cursor-pointer font-medium">New Job</Link>
        </div>
